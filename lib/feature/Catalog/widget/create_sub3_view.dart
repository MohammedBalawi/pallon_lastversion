...
class CreateSub3View extends StatefulWidget {
  final Catalog catalog;
  final SubCatModel sub;
  final SubSubCatModel subsub;

  const CreateSub3View(
      this.catalog,
      this.sub,
      this.subsub, {
        super.key,
  ...
  @override
  State<CreateSub3View> createState() => _CreateSub3ViewState();
}

class _CreateSub3ViewState extends State<CreateSub3View> {
