...
class CreateSub4View extends StatefulWidget {
  ...
  @override
  State<CreateSub4View> createState() => _CreateSub4ViewState();
}

class _CreateSub4ViewState extends State<CreateSub4View> {
      ...
      child: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            Text(
              'قم بإضافة تصنيف في المستوى الرابع ضمن هذا القسم'.tr,
            ...
            TextFormField(
              ...
              decoration: InputDecoration(
                ...
                hintText: 'مثال: فئة فرعية إضافية...'.tr,
                filled: true,
                hintStyle: TextStyle(
                  fontFamily: ManagerFontFamily.fontFamily,
                  fontSize: 14
